...
public interface QueryService<T extends QueryModel> {
   ...
   * @param filters the filters to apply to the query
   * @return a collection of entities with the specified IDs, subject to the page request and
   *     filters
   */
  ...
  /**
   * Retrieves a collection of entities with the specified UIDs, applying the given page request and
   * filters.
   *
   * @param uids the collection of UIDs of the entities to retrieve
   * @param pageRequest the page request that specifies pagination and ordering
   * @param filters the filters to apply to the query
   * @return a collection of entities with the specified UIDs, subject to the page request and
   *     filters
   */
