...
public record Order(String field, Direction direction) {
  ...
  /**
   * Parses a given string into an {@link Order} instance. The string format is expected to be
   * either <code>&lt;field&gt;</code> or <code>&lt;indicator&gt;&lt;field&gt;</code>, where <code>
   * &lt;indicator&gt;</code> is either {@link #ASC_INDICATOR} or {@link #DESC_INDICATOR}. If the
   * indicator is not provided, the direction defaults to ascending.
   *
